...
| Area | Value |
|------|-------|
| Total alerts (7 days) | 374 |
| High severity alerts | 73 |
| Incidents closed | 47 |
| False positives | 182 |
| Avg compliance score | 71% |
| Open risks | 35 |
| Critical risks | 0 |
...
```mermaid
xychart-beta
    title "Total Alerts per Day"
    x-axis ["Sep 19", "Sep 20", "Sep 21", "Sep 22", "Sep 23", "Sep 24", "Sep 25"]
    y-axis "Alerts"
    bar [44, 51, 60, 57, 55, 57, 50]
```
...
```mermaid
xychart-beta
    title "Log Volume per Day (thousands)"
    x-axis ["Sep 19", "Sep 20", "Sep 21", "Sep 22", "Sep 23", "Sep 24", "Sep 25"]
    y-axis "Log entries (k)"
    bar [102, 120, 115, 111, 111, 125, 114]
```
